...
const useGeneratePodcast = ({
  ...
  const uploadPodcast = async (file: File) => {
    ...
    try {
      ...
      toast({
        title: "Error uploading the podcast",
        variant: 'destructive',
      });
      setIsGenerating(false);
    }
  ...
  return { isGenerating, generatePodcast, uploadPodcast }
}

const GeneratePodcast = (props: GeneratePodcastProps) => {
  const { isGenerating, generatePodcast, uploadPodcast } = useGeneratePodcast(props);
